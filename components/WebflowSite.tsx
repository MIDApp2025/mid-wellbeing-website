...
export default function WebflowSite({ page, locale="fi" }: { page: PageKey; locale?: Locale }) {
  ...
  return <main className="wf-site" ref={siteRef}>
    ...
    {page==="miksi" ? <section className="wf-miksi-quote"><Reveal className="wf-miksi-quote-reveal"><blockquote>“Jokainen ajatus syntyy tunteesta – jokaisen tunteen takana on tarina”</blockquote><p>— MID Wellbeingin ydinajatus</p><a href="https://dashboard.midwellbeing.com/startPage">Aloita</a></Reveal></section> : page==="tarjoaa" ? <section className="wf-tarjoaa-quote"><Reveal><blockquote>“Oivallus ohjaa kehitystä”</blockquote><p>Kehitys syntyy uskalluksesta pysähtyä, kokeilla ja oppia.</p><a href="https://dashboard.midwellbeing.com/startPage">Aloita</a></Reveal></section> : page==="testaa" ? <section className="wf-testaa-quote"><Reveal><blockquote>“Hyvinvointi alkaa oivalluksesta – ja jokainen oivallus alkaa uteliaisuudesta”</blockquote><a href="https://mid-demo-73dezblnk-midc-onsulting.vercel.app/">Tee testi</a></Reveal></section> : page==="meista" || page==="ukk" ? null : <section className="wf-end"><Reveal><h2>Muutos alkaa hyvinvoinnista – hyvinvointi alkaa oivalluksesta</h2><a href="https://dashboard.midwellbeing.com/startPage">Aloita</a></Reveal></section>}
